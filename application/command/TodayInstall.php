 ...
 * @package app\command
 */
class TodayInstall extends Command
{
    protected function configure()
    {
        $this->setName('TodayInstall')->setDescription('今日安装量统计');
    }
...
//            if ($today_install_number != 0) {
                ...
                $insert['price'] = $this->getPrice($today_install_number,$user['appid']);
...
//            }
     ...
     */
    public function getPrice($price,$appid)
    {
